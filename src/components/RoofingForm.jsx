...
const RoofingForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert("Form submitted successfully! Connecting you with pros...");
  };
    ...
    <div className="w-full max-w-3xl mx-auto">
      <div className="mb-8">
        <div className="h-1 w-full bg-gray-200 rounded-full overflow-hidden">
          <div 
            className="h-full bg-roof transition-all duration-500 ease-out"
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <FormQuestion
          ...
          onChange={(e) => {
            ...
            if (e.target.value === "Install or replace a roof") {
        ...
        {projectType === "Install or replace a roof" && (
          <FormQuestion
        ...
        {stories && (
          <div className="pt-6 animate-fade-in">
            <button
              type="submit"
              className="w-full py-4 px-6 bg-roof hover:bg-roof-hover text-white font-medium rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-roof-dark"
            >
              Find Pros
            </button>
          </div>
